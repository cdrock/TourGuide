...
void IOTMMachineElfFamiliarGenerateResource(ChecklistEntry [int] resource_entries)
{
    ...
    if (free_fights_remaining > 0 && mafiaIsPastRevision(16550))
    {
        ...
        resource_entries.listAppend(ChecklistEntryMake(entry.image_lookup_name, entry.url, ChecklistSubentryMake(pluralise(free_fights_remaining, "free elf fight", "free elf fights"), modifiers, description)).ChecklistEntryTagEntry("daily free fight").ChecklistEntrySetIDTag("Machine elf free fights"));
    }

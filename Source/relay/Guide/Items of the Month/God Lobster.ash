...
void IOTMGodLobsterGenerateResource(ChecklistEntry [int] resource_entries)
{
    ...
    resource_entries.listAppend(ChecklistEntryMake("__familiar god lobster", url, ChecklistSubentryMake(pluralise(free_fights_left, "free God Lobster fight", "free God Lobster fights"), "", description)).ChecklistEntryTagEntry("daily free fight").ChecklistEntrySetIDTag("God lobster daily fights"));
}

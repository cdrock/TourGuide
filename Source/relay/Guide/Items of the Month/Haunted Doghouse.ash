...
void IOTMHauntedDoghouseGenerateResource(ChecklistEntry [int] resource_entries)
{
    ...
    {
        resource_entries.listAppend(ChecklistEntryMake("__item tennis ball", "", ChecklistSubentryMake(pluralise($item[tennis ball]), "", "Free run/banish."), 6).ChecklistEntryTagEntry("banish").ChecklistEntrySetIDTag("Haunted doghouse banish"));
    }

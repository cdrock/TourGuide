...
void IOTMVotingBootGenerateResource(ChecklistEntry [int] resource_entries)
{
    ...
    if (get_property_int("_voteFreeFights") < 3) {
        resource_entries.listAppend(ChecklistEntryMake("__item &quot;I Voted!&quot; sticker", "", ChecklistSubentryMake(pluralise(vote_free_fights_left, "voting monster", "voting monsters"), "", "Free fight."), 8).ChecklistEntryTagEntry("daily free fight").ChecklistEntrySetIDTag("Voting booth voting monster free fight"));
    }
}
